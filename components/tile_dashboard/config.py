...
def build_font_config(component_id, font_file, glyphs, size):
    ...
    # raw_data_id / raw_glyph_id are auto-generated by ESPHome.
    # Only supply explicit IDs when font.GlyphData is available
    # (removed in ESPHome ≥ 2026.x).
    if hasattr(font, "GlyphData"):
        cfg["raw_data_id"] = ID(
